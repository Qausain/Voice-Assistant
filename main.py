...
def where_born():
    speak('I was created by a developer named Qausain, in Sialkot, the magical land of Pakistan.')
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'time' in query:
            ...
            speak("I am Samaritan, The Smart Assistant of Qausain, Developed to help him around with his work and makes his life easier with his machine")
